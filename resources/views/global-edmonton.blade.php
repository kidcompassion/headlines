...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.3/js/bootstrap.min.js" integrity="sha384-a5N7Y/aK3qNeh15eJKGWxsqtnX/wWdSZSKp+81YjTmS15nvnvxKHuzaWwXHDli+4" crossorigin="anonymous"></script>
    ...
    <div class="container">
        <header>
            ...
            <div class="row p-3">
                <h1 class="col-md-8">Global Edmonton</h1>
                <div class="col-md-2">
                    {{ Form::open() }}
                ...
                <div class="col-md-2">
                    <a class="btn btn-secondary" href="https://globalnews.ca/edmonton/" target="_blank"><i class="fa fa-external-link"></i> Visit Site</a>
                </div>
            </div>
        </header>
        <div class="row">
