    ...
    <div class="container">
        <header>
            ...
            <div class="row p-3">
                ...
                <div class="col-md-2">
                    <a class="btn btn-secondary" href="https://www.thestar.com/edmonton.html" target="_blank"><i class="fa fa-external-link"></i> Visit Site</a>
                </div>
            </div>
        </header>
        <div class="row">
